...
# --- ÖZEL YAHOO MAP'LERİ (BIST yeni kod → eski Yahoo kodu) ---
SPECIAL_YF_MAP = {
...
def get_yahoo_symbol(kod, pazar):
    ...
    # 1) Özel MAP: Yahoo henüz TRMET/TRALT/TRENJ kodlarını tanımıyor
    if kod in SPECIAL_YF_MAP:
        return SPECIAL_YF_MAP[kod]
